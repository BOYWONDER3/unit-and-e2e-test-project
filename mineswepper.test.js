...
import { createBoard, TILE_STATUSES, markedTilesCount, markTile, revealTile, checkWin, checkLose, positionMatch } from "./mineswepper"
...
describe('#checkLose', () => {
    test('with no mines revealed it returns true', () => {
        const board = [[
            { x: 0, y: 0, status: TILE_STATUSES.MARKED, mine: true},
            { x: 0, y: 1, status: TILE_STATUSES.HIDDEN, mine: true}
        ], [
