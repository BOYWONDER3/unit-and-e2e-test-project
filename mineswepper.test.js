...
import { createBoard, TILE_STATUSES, markedTilesCount, markTile, revealTile, checkWin } from "./mineswepper"
...
describe('#checkWin', () => {
    test('test with only hidden and marked mine tiles it returns true', () => {
        const board = [[
            {}
        ]]
    })
